...
@section('content')
<section
    style="padding: 80px 20px; min-height: 90vh; background: none; display: flex; align-items: center; justify-content: center;">
    <div class="container" style="max-width: 700px; width: 100%;">
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            ...
            <p style="color: #636e72; font-size: 1.1rem;" data-en="Resize your images to custom dimensions easily."
        ...
        {{-- Interface Card --}}
        <div
            style="background: rgba(255, 255, 255, 0.7); backdrop-filter: blur(10px); padding: 40px; border-radius: 24px; border: 1px solid rgba(255, 255, 255, 0.3); box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.05);">

            {{-- Upload Area (ใช้ไอคอนรูปภาพและสีเขียวเหมือน Image Converter) --}}
            <div id="drop-zone"
                style="border: 2px dashed #17eb92; padding: 40px; border-radius: 20px; text-align: center; margin-bottom: 25px; cursor: pointer; transition: 0.3s;"
            ...
            <div id="resize-controls" style="display: none;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div>
                        <label style="display: block; margin-bottom: 8px; font-weight: 600; color: #2d3436;"
                            data-en="Width (px)" data-th="ความกว้าง (px)">Width (px)</label>
                        <input type="number" id="resize-width"
                            style="width: 100%; padding: 12px; border-radius: 12px; border: 1px solid #e0e0e0; outline: none; transition: 0.3s;"
                ...
                <div
                    style="margin-bottom: 25px; display: flex; align-items: center; gap: 10px; justify-content: center;">
