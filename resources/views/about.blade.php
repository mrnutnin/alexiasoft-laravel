    ...
    <div class="glass-card" style="padding: 40px 30px; max-width: 900px; margin: 0 auto;">
        <div class="stat-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
            <div style="text-align: center;">
                ...
                <p style="margin: 0; font-size: 0.85rem;" data-en="Reliability" data-th="ความน่าเชื่อถือ">Reliability
                </p>
            </div>
            <div style="text-align: center;">
                <h3 style="margin: 0 0 8px 0; font-size: 1.8rem;">6+</h3>
                <p style="margin: 0; font-size: 0.85rem;" data-en="Experience" data-th="ประสบการณ์">Years Experience</p>
            </div>
            <div style="text-align: center;">
            ...
            <div style="text-align: center;">
                ...
                <p style="margin: 0; font-size: 0.85rem;" data-en="Active Support" data-th="ดูแลตลอดเวลา">Active Support
                </p>
            </div>
        </div>
    </div>
