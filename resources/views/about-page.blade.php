        ...
        <div class="glass-card" style="padding: 40px 30px; max-width: 900px; width: 100%; margin: 0 auto;">
            <div class="stat-grid" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px;">
                ...
                <div style="text-align: center;">
                    ...
                    <p style="margin: 0; font-size: 0.85rem; color: #666;" data-en="Success Project" data-th="โครงการที่สำเร็จ">
                        Success Projects
                    </p>
                </div>
                <div style="text-align: center;">
        ...
        <div class="about-row glass-card">
            ...
            <div>
                ...
                <ul class="about-list">
                    ...
                    <li data-en="Customer-focused mindset" 
                        data-th="ให้ความสำคัญกับลูกค้าเป็นศูนย์กลาง">
